...
<body>
    ...
    <div class="sidebar shadow">
        ...
        <a href="{{ route('categories.store') }}"><i class="fas fa-plus-circle"></i> Add New category</a>
    ...
    <div class="main-content">
        <nav class="top-navbar d-flex justify-content-between align-items-center">
            ...
            <div class="dropdown">
                <button class="btn dropdown-toggle d-flex align-items-center" type="button" id="profileMenu"
                ...
                <ul class="dropdown-menu dropdown-menu-end shadow border-0" aria-labelledby="profileMenu">
                    <li>
                        <h6 class="dropdown-header text-primary">admin Info</h6>
                    </li>
                    <li><a class="dropdown-item" href="#"><i class="fas fa-user-circle"></i> Profile Details</a>
                    </li>
